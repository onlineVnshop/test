...
String menuData=(String)request.getSession().getAttribute("menuData");
							...
							<div id="rbox_topcenter">
								<div>
									...
									<ul>
										...
										<li><b></b></li>
										<li><a href="<%=contextPath %>/customer/getshopdata.do" target="frmright"><span class="icon_home">店铺首页</span></a></li>
										<%-- <li><b></b></li>
										<li><a href="<%=contextPath %>/menu/menuUrl.do?menuId=49" target="frmright"><span class="icon_user">个人中心</span></a></li> --%>
										<li><b></b></li>
										<li><a href="<%=contextPath%>/system/layout_html/mainselect.jsp" target="_parent"><span class="icon_list">切换店铺</span></a></li>
										<li><b></b></li>
