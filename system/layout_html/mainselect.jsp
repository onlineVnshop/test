...
String ucenter=(String)request.getSession().getAttribute("ucenter");
...
function windowClose(){
	...
	$.post("<%=contextPath%>/system/logout.do",
			{},
				function(result){
					flag="";
		...
		<td class="ali01 ver01"  width="100%">
							...
							<div id="rbox_topcenter">
								<div>
									...
									<div id="positionContent">选择店铺</div>
									<ul>
										...
										<%--  <li><b></b></li>
										<li><a href="<%=contextPath %>/menu/menuUrl.do?menuId=49" target="frmright"><span class="icon_user">个人中心</span></a></li> --%>
										<!-- <li><b></b></li> -->
										<li style="padding-right:30px;"><span class="icon_exit" onclick="top.Dialog.confirm('确定要退出系统吗',function(){windowClose()});">退出系统</span></li>
										<div class="clear"></div>
									</ul>
									<div class="clear"></div>
								</div>
							...
							<div id="rbox_middlecenter">
								<div id="rbox_middleleft">
									<div id="rbox_middleright">
										<div id="bs_right">
											 <IFRAME style="box-sizing: border-box; background: white;" height="100%" width="100%" frameBorder=0 id=frmright name=frmright src="<%=contextPath %>/system/layout_html/shoplist.jsp" allowTransparency="true"></IFRAME> 										
										 </div>
									</div>
								</div>
							</div>
