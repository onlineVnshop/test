...
String userid=request.getParameter("userid");
 %>
	...
	<div class="regcon">
        ...
        </a><span class="m-fntit">店铺授权</span>
        <div class="ui_tab">
                    ...
                    <div class="fnlogin fnlogin3 clearfix">
                      <form id="myFormId" method="post" action="">
                        ...
                        <div class="line liney clearfix">
                            ...
                            <div class="liner">
                                <a class="regbtn J_btn_agree" id="regbtn" href="javascript:;" onClick="register('#myFormId')">同意授权</a>
                            </div>
                    </div>
 </form> 
                    </div>
...
function register(containerId){
	...
	var formUrl="<%=contextPath%>/register/shopgrant.do";
	$.ajax({
		type:"post", //请求方式
		url:formUrl, //发送请求地址
