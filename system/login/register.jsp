...
if (info == null) {
 ...
 %>
	...
	<div class="regcon">
        ...
        </a><span class="m-fntit">欢迎注册</span>
        <div class="ui_tab">
               ...
               <div class="m-fnbox ui_panel" style="display: block;">
                    <div class="fnlogin fnlogin3 clearfix">
                      <form id="myFormId" method="post" action="">
                        <div class="line">
                            <label class="linel"><span class="dt"> <span class="star">*</span>真实姓名：</span></label>
                            <div class="liner">
                                <input type="text" class="inp femail J_email validate[required,custom[chinese]]" name="loginName" placeholder="请输入真实姓名" /><p class="fn-fl errorbox v-txt" id="emailBox">邮箱格式输入不正确</p>
                            </div>
                        </div>
                        ...
                        <div class="line liney clearfix">
                            ...
                            <div class="liner">
                                <a class="regbtn J_btn_agree" id="regbtn" href="javascript:;" onClick="register('#myFormId')">注册</a>
                            </div>
                    </div>
 </form> 
                    </div>
...
function phoneblur(phone){
	var $this=$(phone);
	 var mobileFormat = validateRules.isMobile($this.val());
	 if(!mobileFormat){
		 alert("手机号不正确！");
	 }  
}
...
function register(containerId){
 ...
 if(valid == true){
	...
	var formUrl="<%=contextPath%>/register/register.do";
	$.ajax({
		type:"post", //请求方式
		url:formUrl, //发送请求地址
